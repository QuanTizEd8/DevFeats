...
#
# Discovers and runs every test/features/<feature>/macos/*.sh script in
# alphabetical order.  Each scenario script receives the repository root as
...
SCENARIOS_DIR="${REPO_ROOT}/test/features/${FEATURE}/macos"
