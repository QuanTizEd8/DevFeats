...
# Requires lib/file.bash and lib/logging.sh (loaded by __init__.bash; order vs api does not matter).
# Registers the bash logging backend for logging.sh dispatch hooks.
