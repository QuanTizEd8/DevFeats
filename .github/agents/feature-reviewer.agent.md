...
- `src/<feature>/devcontainer-feature.json` — check `ospkg_manifest_*` options when `_dependencies` is declared
...
Read the general test writing instructions before writing tests: `.github/instructions/test.instructions.md`. When in doubt, read [Feature Tests](/docs/source/dev-guide/tests/features.md) for comprehensive testing documentation and examples.
