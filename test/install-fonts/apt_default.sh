...
check "Meslo fonts installed" bash -c 'find '"$_FONTS"' -path "*/devfeats-install-fonts-*/nerd/Meslo/*.ttf" | grep -q .'
check "JetBrainsMono fonts installed" bash -c 'find '"$_FONTS"' -path "*/devfeats-install-fonts-*/nerd/JetBrainsMono/*.ttf" | grep -q .'
