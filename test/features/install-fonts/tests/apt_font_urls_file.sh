...
# namespaced devfeats-install-fonts-*/url/<host>/<path>/ directory,
...
check "font file installed" bash -c 'find '"$_FONTS"' -path "*/devfeats-install-fonts-*/url/*" -name "JetBrainsMono-Regular.ttf" | grep -q .'
