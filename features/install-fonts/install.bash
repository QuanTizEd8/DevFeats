...
__install_run__() {
  local _P10K_BASE_URL="https://github.com/romkatv/powerlevel10k-media/raw/master"
  local _NF_BASE_URL="https://github.com/ryanoasis/nerd-fonts/releases/latest/download"
