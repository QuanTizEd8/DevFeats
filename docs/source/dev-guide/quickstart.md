...
- **Shared library**: Prefer `lib/` helpers over duplicating logic. See `docs/dev-guide/writing-features.md` for the full API (tables are also injected into `.github/instructions/lib.instructions.md` via `just sync-docs`).
