...
- `src/`: **Fully auto-generated and gitignored** — assembled from `features/` by `sync-lib.sh`. Consumed by the devcontainer CLI and build tooling. **Never edit files here directly.**
